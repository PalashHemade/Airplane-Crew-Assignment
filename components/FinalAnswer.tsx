...
export default function FinalAnswer({ assignments, matrix }: FinalAnswerProps) {
  ...
  return (
    <div className="bg-gradient-to-br from-emerald-950/60 to-gray-900 border border-emerald-500/40 rounded-2xl p-5 space-y-4 shadow-lg shadow-emerald-900/30">
      {/* Header */}
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">
            Branch &amp; Bound has finished — no better solution exists.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-2">
        {assignments
          ...
          .map((a) => (
            <div
              key={a.crew}
              className="flex items-center justify-between bg-emerald-950/40 border border-emerald-500/20 rounded-xl px-4 py-2.5"
            >
